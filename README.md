...
This was used as group club practice to teach each other how to use Scala and Spark. We processed lines from Shakespeare and made a fun story to go along with it.
